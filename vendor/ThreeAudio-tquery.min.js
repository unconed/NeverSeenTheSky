...
ThreeAudio.Source.prototype={init:function(){var a=this.context=new webkitAudioContext;this.audible=a.createDelay();this.inaudible=a.createDelay();this.analyser=a.createAnalyser();var c=this.analyser.fftSize=this.fftSize,f=this.filters;_.each({bass:{type:0,frequency:160,Q:1.2,gain:2},mid:{type:2,frequency:500,Q:1.2,gain:4},treble:{type:1,frequency:2E3,Q:1.2,gain:3}},function(d,e){var h=a.createBiquadFilter();h.key=e;h.type=d.type;h.frequency.value=d.frequency;h.Q.value=d.Q;h.analyser=a.createAnalyser();
h.analyser.fftSize=c;h.delayNode=a.createDelay();h.delayNode.delayTime.value=0;h.gainNode=a.createGain();h.gainNode.gain.value=d.gain;f[e]=h});this.delay=a.createDelay();this.delay.delayTime.value=2*this.fftSize/a.sampleRate;this.audible.connect(this.analyser);this.inaudible.connect(this.analyser);this.audible.connect(this.delay);this.delay.connect(a.destination);var d=this.audible,e=this.inaudible;_.each(f,function(a){d.connect(a.delayNode);e.connect(a.delayNode);a.delayNode.connect(a);
